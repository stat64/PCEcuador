        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                        <img class="img-responsive center-all-contens" src="assets/img/PlantasCarnivoras-logo.png" style="opacity: .4">
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div id="form-compra">
                                ...
                                if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
                                    ...
                                    echo '
                                        ...
                                        <p>
                                            ...
                                            y contraseña con la cual te registraste en : &emsp;    <span class="tittles-pages-logo">'. $n.'</span>.
                                        </p>
                                        <br>
                                      <div class="form-group">
                                        <div class="input-group">
                                          <div class="input-group-addon"><i class="fa fa-at"></i></div>
                                          <input class="form-control all-elements-tooltip" type="email" placeholder="Ingrese su correo" required name="clien-name" data-toggle="tooltip" data-placement="top" title="Ingrese su nombre" maxlength="50">
                                        </div>
                                      </div>
                                      <br>
                                      <div class="form-group">
