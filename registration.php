        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios - <small class="tittles-pages-logo"><?php echo $n;?></small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <img class="center" src="assets/img/img-registration.png" width="430px" alt="img-registration" class="img-responsive">
                </div>
