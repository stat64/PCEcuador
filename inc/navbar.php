<?php 
    session_start();
    $n='!revise el acceso a la bdd';
    $tt='!revise el acceso a la bdd';
    $st='!revise el acceso a la bdd';
    $m='!revise el acceso a la bdd';
    $f=null;
    $t=null;
    $gp=null;
    $gl=null;
    ...
    $dsweb=ejecutarSQL::consultar("select * from datosWeb WHERE id_datos='1'");
...
<nav id="navbar-auto-hidden blue">
                        ...
                        <?php
                            if(!$_SESSION['nombreAdmin']==""){
                                echo ' 
                                    ...
                                    <a href="#" class="table-cell-td" data-toggle="modal" data-target=".modal-logout" title="Cerrar sesión">
                                               <i class="fa fa-user">&nbsp;&nbsp;'.$_SESSION['nombreAdmin'].'</i> 
                                    </a>
                                ...
                                echo ' 
                                    <a href="product.php" class="table-cell-td">Productos</a>
                                    <a href="compras.php" class="table-cell-td">Compras</a>
                                    <a href="configUser.php" class="table-cell-td">Configuraciones</a>
                                    ...
                                    <a href="#" class="table-cell-td" data-toggle="modal" data-target=".modal-logout" title="Cerrar sesión">
                                               <i class="fa fa-user">&nbsp;&nbsp;'.$_SESSION['nombreUser'].'</i> 
                                    </a>
            ...
            <div class="col-xs-12">
                ...
                if(!$_SESSION['nombreAdmin']==""){echo '
                    ...
                    echo ' 
                                    ...
                                    <a href="#" class="elements-nav-xs" data-toggle="modal" data-target=".modal-login">
                                        <i class="fa fa-user"></i>&nbsp;&nbsp;Login
                                    </a>
                                 ';
                }
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en: <br> <?php echo $n;?></h4>
                </div>
            <form action="process/login.php" method="post" role="form" style="margin: 20px;" class="FormCatElec" data-form="login">
                  <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="nombre-login" placeholder="Escribe tu email" required=""/>
                  </div>
                  <div class="form-group">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo"><?php echo $n;?></h3>
    ...
    <!-- Fin Modal logout -->
    <!-- Modal logout -->
    <div class="modal fade modal-detalle" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="padding: 20px;">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <br>
                <p class="text-center">Detalles de la compra</p>
                <p class="text-center"><i class="fa fa-user fa-5x"></i></p>
                <p class="data-n_pedido_ven"></p>
                <?php
                echo '2';
                ?>
                <p class="text-center">
